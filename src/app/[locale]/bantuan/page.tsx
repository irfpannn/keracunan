...
export default function HelpPage() {
  ...
  const helpItems = [
    ...
    },
    {
      ...
      description:
        locale === "ms"
          ? "Cari klinik kesihatan kerajaan berhampiran anda"
          : "Find government health clinics near you",
    ...
    },
    {
      ...
      description:
        locale === "ms"
          ? "Nombor penting untuk situasi kecemasan"
          ...
          <CardContent className="p-4 flex items-center justify-between gap-4">
            <div>
              ...
              <p className="text-sm opacity-90">
                {locale === "ms"
                  ? "Untuk gejala teruk, hubungi segera:"
                  : "For severe symptoms, call immediately:"}
              </p>
            </div>
